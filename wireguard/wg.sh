...
# ==================================================
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/Fahmiiiiiiii/scriptvps/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${Fahmiiiiiiii}/addwg.sh"
wget -O delwg "https://${Fahmiiiiiiii}/delwg.sh"
wget -O renewwg "https://${Fahmiiiiiiii}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
